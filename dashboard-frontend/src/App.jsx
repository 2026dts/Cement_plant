...
const SENSOR_TILES = [
  ...
  { id: "dht1_temp", label: "Kiln Area Temp", source: "esp2" },
  { id: "dht1_humidity", label: "Kiln Area Humidity", source: "esp2" },
  { id: "dht2_temp", label: "Cooler Area Temp", source: "esp2" },
  { id: "dht2_humidity", label: "Cooler Area Humidity", source: "esp2" },
...
const ACTUATORS = [
  ...
  { id: "clin_cooler_fan", label: "Clin Cooler Fan" },
